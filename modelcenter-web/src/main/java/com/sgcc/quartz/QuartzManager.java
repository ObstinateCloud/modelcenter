...
public class QuartzManager {
	...
	@Autowired
	private  SchedulerFactoryBean gSchedulerFactory;
	...
	public  void modifyJob(String oldJobName, String jobName, Class jobclass, String cron) {
		/*
		 * removeJob(oldJobName); addJob(jobName, jobclass, cron);
	...
	/**
	 * @Description: 获取任务状态 NONE: 不存在 NORMAL: 正常 PAUSED: 暂停 COMPLETE:完成 ERROR :
	 *               错误 BLOCKED : 阻塞
	 * @param jobName
	 *            触发器名
	 * 
